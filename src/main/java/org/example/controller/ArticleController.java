...
public class ArticleController extends Controller {
    ...
    public void showList() {
        String searchKeyword = cmd.substring("1 list".length()).trim();
        ...
        for (int i = forPrintArticles.size() - 1; i >= 0; i--) {
            ...
            System.out.printf("%4d | %4s | %5s  : %4d\n", article.id,
                    article.title, member.name, article.hit);
        }
    }
    ...
    private void articleRepliesShowList(int articleId){
        ...
        System.out.printf("%d번 게시물 댓글", articleId);
    ...
    public void doDelete() {
        ...
        System.out.printf("삭제할 게시물 번호를 입력하세요)\n");
